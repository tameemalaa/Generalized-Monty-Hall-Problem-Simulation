...
def main() :
    ...
    t1.add_column("Win Percent % ",[pick_perc[-1],switch_perc[-1],random_perc[-1]])
    t2 = PrettyTable()
    t2.add_column("Theoretical Switch Win Percent % ",[switch_theo])
    t2.add_column("Simulation Switch Win Percent % ",[switch_perc[-1]])
    print(t1)
    print(t2)
    plt.show()
